    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        windowrule = [
          ...
          "match:class ^(zoom)$, no_blur"
          "match:class ^(yad)$, stay_focused"
          # Picture-in-Picture
          "match:title ^([Pp]icture[-\s]?[Ii]n[-\s]?[Pp]icture)(.*)$, blur"
          "match:title ^([Pp]icture[-\s]?[Ii]n[-\s]?[Pp]icture)(.*)$, move 73% 72%"
          "match:title ^([Pp]icture[-\s]?[Ii]n[-\s]?[Pp]icture)(.*)$, size 25%"
          "match:title ^([Pp]icture[-\s]?[Ii]n[-\s]?[Pp]icture)(.*)$, blur"
          "match:title ^([Pp]icture[-\s]?[Ii]n[-\s]?[Pp]icture)(.*)$, pin"
          # Dialog windows – float+center these windows.
          "match:title ^(Open File)(.*)$, center"
          "match:title ^(Select a File)(.*)$, center"
          "match:title ^(Choose wallpaper)(.*)$, center"
          "match:title ^(Open Folder)(.*)$, center"
          "match:title ^(Save As)(.*)$, center"
          "match:title ^(File Upload)(.*)$, center"
          "match:title ^(Open File)(.*)$, float"
          "match:title ^(Select a File)(.*)$, float"
          "match:title ^(Choose wallpaper)(.*)$, float"
