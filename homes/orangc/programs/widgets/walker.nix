...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    programs.walker = {
        ...
        plugins = [
          {
            ...
            name = "minecraft";
            prefix = "mc";
            src_once = "basename -a \"$XDG_DATA_HOME/PrismLauncher/instances/\"*/";
            cmd = "prismlauncher --launch %RESULT%";
          }
        ];
        keys = {
      ...
      theme.style = ''
        @define-color foreground ${colours.base05};
        @define-color background ${colours.base00};
        @define-color accent ${colours.base0E};
